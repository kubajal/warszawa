...
const APP_ROOT = "warszawa"; // Github only, for local dev change to empty
...
(function () {
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const manifest = fetch(`/${APP_ROOT}/html/generated/manifest.json`)
            .then(r => r.json()); const container = document.getElementById("selector_placeholder");
